...
function updateCharPreview() {
    ...
    for (var i = 0; i < maxLen; i++) {
        ...
        // ✅ Ký tự sai/thừa → có thể click để sửa
        if (clickable) {
...
/* ✅ Click vào ký tự sai → đưa con trỏ về đó và bôi đen để gõ đè */
window.fixCharAt = function(idx, el) {
    ...
    // Đặt con trỏ về vị trí idx và bôi đen 1 ký tự
    setTimeout(function() {
        try {
        ...
        // ✅ Highlight animation cho ký tự vừa click
        if (el) {
