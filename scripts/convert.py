...
/* ✅ Khung đáp án tiếng Trung inline */
...
/* ✅ Hiển thị kết quả chấm + đáp án tiếng Trung đầy đủ */
function showInlineCheckWithAnswer(input) {
    ...
    cells.forEach(function(c) {
        c.innerHTML = resultHtml + answerHtml;
    });
}
...
/* ✅ Toggle ẩn/hiện kết quả + đáp án ở mỗi thẻ */
